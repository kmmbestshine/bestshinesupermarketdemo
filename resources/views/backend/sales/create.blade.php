                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form id="btnSave" action="{{route('sales.store')}}" method="POST">
                                ...
                                <input style="display:none;" type="text" name="buyer_name" id="buyer_name" placeholder="Buyer Name"/>
                            <input style="display:none;" type="text" pattern="^\d{10}$" name="phoneno" id="phoneno" placeholder="Buyer Phone no"/>
                            <br>
                            <br>
